...
export default function Page() {
  ...
  const weekConfig = {
    ...
    title: 'JSP con Jakarta y Spring',
    subtitle: 'Java Server Pages & Jakarta EE',
  ...
  const examples = [
    {
      ...
      description: 'Creación de una página JSP integrada con Spring MVC',
      icon: <Code className="w-5 h-5 text-blue-600" />,
      gradient: 'from-blue-500 via-cyan-500 to-teal-500',
      reflection: 'Estructurar páginas con JSP integrado con Spring MVC permite crear aplicaciones web dinámicas y mantenibles. La separación entre la vista (JSP) y la lógica de negocio (Controller) facilita el desarrollo y testing. El uso de JSTL proporciona una forma elegante de manipular datos sin scriptlets Java embebidos.',
      code: `<%-- /WEB-INF/views/productList.jsp --%>
...
<body>
    ...
    {
      id: 2,
      title: 'Jakarta EE Servlet',
      description: 'Implementación de un servlet con Jakarta EE',
      icon: <Database className="w-5 h-5 text-pink-600" />,
      gradient: 'from-purple-500 via-pink-500 to-rose-500',
      reflection: 'Los servlets son componentes fundamentales en Jakarta EE que procesan peticiones HTTP. Actúan como controladores que manejan la lógica de negocio, interactúan con la capa de datos y determinan qué vista mostrar. Su ciclo de vida y manejo de sesiones son esenciales para aplicaciones web robustas.',
      code: `package com.example.servlets;
...
public class ProductServlet extends HttpServlet {
  ...
  const resources = [
    ...
    {
      title: 'Oracle JSP Tutorial',
      url: 'https://docs.oracle.com/javaee/5/tutorial/doc/bnagx.html',
      icon: <ExternalLink className="w-4 h-4" />,
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-purple-50 to-pink-50 relative overflow-hidden">
      ...
      <div className="relative bg-gradient-to-br from-orange-600 via-red-600 to-pink-600 text-white overflow-hidden">
        ...
        <div className="container mx-auto px-6 py-12 relative z-10">
          {/* Back button - Ahora es un Link a la página principal */}
          ...
          <div className="flex items-center justify-between gap-12">
            ...
            {/* Illustration - Completely redesigned */}
            <div 
                    ...
                    <div className="absolute -bottom-20 left-0 space-y-3">
                      {[28, 36, 24, 32].map((width, i) => (
                        <div key={i} className="flex items-center gap-3 animate-pulse" style={{ animationDelay: `${i * 200}ms` }}>
                          ...
                          <div className={`h-2.5 bg-white/50 backdrop-blur-sm rounded-full transition-all duration-500 shadow-lg`} style={{
                            width: `${width * (isHoveringIllustration ? 1.3 : 1)}px`
                          }}></div>
                        </div>
                      ))}
                    </div>
      ...
      <div className="bg-white/90 backdrop-blur-xl border-t-2 border-gray-200 shadow-2xl mt-16">
        <div className="container mx-auto px-6 py-8">
          <div className="flex items-center justify-between">
            {/* Semana anterior: lleva a semana 1 */}
            <Link href="/projects/semana-6" className="flex items-center gap-3 text-gray-700 hover:text-orange-600 font-bold transition-all duration-300 hover:gap-4 px-6 py-3 rounded-xl hover:bg-orange-50 text-lg">
            ...
            {/* Siguiente semana: lleva a semana 3 */}
            <Link href="/projects/semana-1" className="flex items-center gap-3 bg-gradient-to-r from-orange-600 via-red-600 to-pink-600 text-white px-8 py-4 rounded-2xl font-bold shadow-2xl hover:shadow-3xl transition-all duration-300 hover:gap-4 transform hover:scale-105 text-lg">
