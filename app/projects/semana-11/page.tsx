...
const weekConfig = {
	number: 11,
	icon: '☕',
	iconBg: 'bg-gradient-to-br from-blue-600 via-indigo-500 to-violet-500',
...
export default function Week10Page() {
	...
	return (
		<div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-violet-50">
			...
			{/* Header animado */}
			<div className="relative overflow-hidden bg-gradient-to-br from-blue-600 via-indigo-500 to-violet-500 text-white">
				<div className="absolute inset-0 opacity-20">
					...
					<div className="absolute -bottom-8 left-20 w-72 h-72 bg-violet-200 rounded-full mix-blend-overlay filter blur-3xl animate-blob animation-delay-4000"></div>
				</div>
						...
						{tabs.map((tab) => (
							<button
								...
								className={`flex items-center gap-2 px-6 py-3 rounded-xl font-bold transition-all duration-300 whitespace-nowrap ${
									activeTab === tab.id
										? 'bg-gradient-to-r from-blue-600 to-violet-500 text-white shadow-xl scale-105'
				...
				<div className="animate-fade-in-up">
					...
					{activeTab === 'contenido' && (
						<div className="w-full flex justify-center">
							<div className="w-full max-w-4xl bg-white/95 rounded-3xl shadow-2xl p-10 md:p-14 border border-indigo-100">
					...
					{activeTab === 'practicas' && (
						<div className="w-full flex justify-center">
							<div className="w-full max-w-4xl bg-white/95 rounded-3xl shadow-2xl p-10 md:p-14 border border-indigo-100">
								...
								<ul className="list-none pl-0 text-base text-blue-700 space-y-1 mb-4">
    ...
    <p>La fecha y hora actual es: <%= new java.util.Date() %></p>
					...
					{activeTab === 'bibliografia' && (
						<div className="space-y-10">
							<div className="flex items-center gap-4 mb-10">
								<div className="p-4 bg-gradient-to-br from-blue-500 to-violet-500 rounded-3xl shadow-2xl">
							...
							<div className="grid md:grid-cols-2 gap-8">
								{recursos.map((resource, index) => (
									<a
										...
										className="group relative block bg-white/90 backdrop-blur-sm rounded-3xl p-8 shadow-xl hover:shadow-2xl transition-all duration-500 border-2 border-transparent hover:border-indigo-300 overflow-hidden hover:-translate-y-2"
					...
					{activeTab === 'reflexion' && (
						<div className="space-y-8">
							<div className="flex items-center gap-4 mb-10">
								<div className="p-4 bg-gradient-to-br from-indigo-500 to-violet-500 rounded-3xl shadow-2xl">
									<Lightbulb className="w-7 h-7 text-white" />
								</div>
								<h3 className="text-4xl font-black text-gray-800">Reflexión de Aprendizaje</h3>
							</div>
							
							<div className="bg-gradient-to-br from-blue-50 via-indigo-50 to-violet-50 border-l-4 border-blue-600 p-10 rounded-3xl shadow-lg mb-8">
							...
							<div className="bg-gradient-to-br from-indigo-50 via-violet-50 to-fuchsia-50 border-l-4 border-indigo-600 p-10 rounded-3xl shadow-lg mb-8">
							...
							<div className="bg-gradient-to-br from-violet-50 via-fuchsia-50 to-pink-50 border-l-4 border-violet-600 p-10 rounded-3xl shadow-lg mb-8">
							...
							<div className="bg-gradient-to-br from-fuchsia-50 via-pink-50 to-rose-50 border-l-4 border-fuchsia-600 p-10 rounded-3xl shadow-lg">
			...
			<div className="bg-white/90 backdrop-blur-xl border-t-2 border-gray-200 shadow-2xl mt-16">
				<div className="container mx-auto px-6 py-8">
					<div className="flex items-center justify-between">
						<a href="/projects/semana-9" className="flex items-center gap-3 text-gray-700 hover:text-blue-600 font-bold transition-all duration-300 hover:gap-4 px-6 py-3 rounded-xl hover:bg-blue-50 text-lg">
						...
						<a href="/projects/semana-13" className="flex items-center gap-3 bg-gradient-to-r from-blue-600 via-indigo-500 to-violet-500 text-white px-8 py-4 rounded-2xl font-bold shadow-2xl hover:shadow-3xl transition-all duration-300 hover:gap-4 transform hover:scale-105 text-lg">
							Siguiente Semana
